...
public class Cat extends animal {
    private static final int globalRunLimit = 201;
    private static final int globalJumpLimit = 3;
    private static final int globalSwimLimit = 0;



    private static final String SPECIES_NAME = "cat";
